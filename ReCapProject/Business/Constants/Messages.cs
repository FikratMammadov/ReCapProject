...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string CarAddedInvalid = "Name must be minimum 2 character and daily price must be creater than 0.";
        ...
        public static string CustomerAddedInvalid = "This user is customer";
